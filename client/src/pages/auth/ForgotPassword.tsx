        ...
        <div className="h-screen overflow-hidden grid lg:grid-cols-2 bg-white font-sans">
            <div className="hidden lg:flex flex-col justify-between p-12 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-sm">
                    <h2 className="text-4xl font-bold leading-tight mb-6">Lost Your <span className="text-emerald-600">Key</span>?</h2>
            ...
            <div className="flex items-center justify-center p-6 md:p-10 lg:p-12 bg-slate-50/50">
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="max-w-lg w-full">
                    ...
                    {message && (
                        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className={`p-4 mb-6 rounded-xl text-sm font-medium border ${isSuccess ? 'bg-green-50 text-green-600 border-green-100' : 'bg-emerald-50 text-emerald-600 border-emerald-300'}`}>
                            {message}
                        </motion.div>
                    )}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-4 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all text-base"
                    ...
                    <div className="mt-10 text-center">
                        <Link to="/login" className="text-sm font-bold text-slate-500 hover:text-emerald-700 flex items-center justify-center gap-2">
