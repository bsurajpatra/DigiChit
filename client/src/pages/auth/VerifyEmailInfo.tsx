        ...
        <div className="h-screen overflow-hidden grid lg:grid-cols-2 bg-white font-sans">
            <div className="hidden lg:flex flex-col justify-between p-12 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-sm">
                    <h2 className="text-4xl font-bold leading-tight mb-6">Almost <span className="text-emerald-600">There</span>.</h2>
            ...
            <div className="flex items-center justify-center p-6 md:p-10 lg:p-12 bg-slate-50/50">
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="max-w-lg w-full text-center lg:text-left">
                    ...
                    <p className="text-base text-slate-600 mb-8 leading-relaxed">
                        We've sent a 24-hour verification link to your email address. 
                        Please click the link in your inbox to activate your account and start your financial journey.
                    </p>
                    <div className="space-y-4">
                        ...
                        <div className="text-center text-sm text-slate-600 pt-2">
                            Didn't receive the email? <Link to="/resend-verification" className="text-emerald-600 font-bold hover:underline">Resend Verification Link</Link>
                        </div>
                    </div>
                </motion.div>
            </div>
